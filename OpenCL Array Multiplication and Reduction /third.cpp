...
main( int argc, char *argv[ ] )
{
	...
	// Return an array, the same size as the number of work-groups. Each element of
	// the array will have the sum from all the items in one work-group. Add up the elements of the array yourself.
	float *hA = new float[ NUM_ELEMENTS ];
	float *hB = new float[ NUM_ELEMENTS ];
	float *hC = new float[ NUM_WORK_GROUPS ];
	//opencl.reduction.2pp.pdf Page 3
